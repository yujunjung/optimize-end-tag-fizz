...
var y = Object.assign,
  ...
  za = {};
function Fa(a) {
  if (z.call(za, a)) return !0;
  if (z.call(ya, a)) return !1;
  if (xa.test(a)) return (za[a] = !0);
  ya[a] = !0;
  return !1;
}
var Ga = new Set(
...
var Ja = /([A-Z])/g,
  Ka = /^ms-/,
  La = Array.isArray,
  Ma = ha.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
...
var wc = x("\n"),
  xc = /^[a-zA-Z][a-zA-Z:_\.\-\d]*$/,
  yc = new Map();
function T(a) {
  var b = yc.get(a);
  if (void 0 === b) {
    if (!xc.test(a)) throw Error("Invalid tag: " + a);
    b = x("<" + a);
    yc.set(a, b);
  }
  return b;
}
var zc = x("<!DOCTYPE html>");
function Ac(a, b, c, d, e, f, g) {
  switch (b) {
    ...
    case "input":
      ...
      var dd = $b(a, d, e, S, Z, I, la, pa);
      null !== ra ? Ub(a, "checked", ra) : null !== Na && Ub(a, "checked", Na);
      null !== J ? O(a, "value", J) : null !== qa && O(a, "value", qa);
      a.push(Zb);
      null !== dd && dd.forEach(Yb, a);
      return null;
    case "button":
      a.push(T("button"));
      var ab = null,
      ...
      var kd = $b(a, d, e, gd, hd, id, jd, fd);
      a.push(Q);
      null !== kd && kd.forEach(Yb, a);
      bc(a, ed, ab);
      if ("string" === typeof ab) {
        a.push(A(ab));
        var ld = null;
    ...
    case "form":
      ...
      if ("function" === typeof sa)
        if ("function" === typeof sa.$$FORM_ACTION) {
          ...
          a.push(L, "action", M, Wb, G), (fb = eb = db = sa = null), ac(d, e);
      null != sa && O(a, "action", sa);
      null != db && O(a, "encType", db);
      null != eb && O(a, "method", eb);
      null != fb && O(a, "target", fb);
      a.push(Q);
      null !== lc &&
        (a.push(Xb),
        N(a, "name", lc),
        a.push(Zb),
        null !== kc && kc.forEach(Yb, a));
      bc(a, md, cb);
      if ("string" === typeof cb) {
        a.push(A(cb));
        var nd = null;
    ...
    case "title":
      if (3 === f.insertionMode || f.tagScope & 1 || null != c.itemProp)
        var pd = rc(a, c);
      else rc(e.hoistableChunks, c), (pd = null);
      return pd;
    case "link":
    ...
    case "script":
      ...
      if (
        ...
        if ("module" === c.type) {
          ...
          var rd = e.preloads.moduleScripts;
        } else (Db = d.scriptResources), (rd = e.preloads.scripts);
        var Eb = Db.hasOwnProperty(Cb) ? Db[Cb] : void 0;
        if (null !== Eb) {
          Db[Cb] = null;
          var nc = c;
          if (Eb) {
            2 === Eb.length && ((nc = y({}, c)), ic(nc, Eb));
            var sd = rd.get(Cb);
            sd && (sd.length = 0);
          }
          var td = [];
    ...
    case "style":
      ...
      if (
        ...
        var Ba = e.styles.get(Fb);
        if (
          null !==
          (d.styleResources.hasOwnProperty(Aa) ? d.styleResources[Aa] : void 0)
        ) {
          d.styleResources[Aa] = null;
          Ba
            ? Ba.hrefs.push(A(Aa))
            : ((Ba = {
                precedence: A(Fb),
          ...
          var jb = Array.isArray(Qa) ? (2 > Qa.length ? Qa[0] : null) : Qa;
          "function" !== typeof jb &&
            "symbol" !== typeof jb &&
            null !== jb &&
            void 0 !== jb &&
        ...
        Ba && e.boundaryResources && e.boundaryResources.styles.add(Ba);
        g && a.push(Mb);
        vd = void 0;
      }
      return vd;
        ...
        g && a.push(Mb),
          (yd =
            "string" === typeof c.charSet
              ? jc(e.charsetChunks, c, "meta")
              : "viewport" === c.name
              ? jc(e.preconnectChunks, c, "meta")
              : jc(e.hoistableChunks, c, "meta"));
      return yd;
    case "listing":
    case "pre":
      a.push(T(b));
      ...
      if (null != lb) {
        ...
        if ("object" !== typeof lb || !("__html" in lb))
          throw Error(
            "`props.dangerouslySetInnerHTML` must be in the form `{__html: ...}`. Please visit https://reactjs.org/link/dangerously-set-inner-html for more information."
          );
        var Ca = lb.__html;
    ...
    case "img":
      ...
      if (
        ...
        var zd = "string" === typeof c.sizes ? c.sizes : void 0,
          nb = K ? K + "\n" + (zd || "") : P,
          pc = e.preloads.images,
          Da = pc.get(nb);
        if (Da) {
          if ("high" === c.fetchPriority || 10 > e.highImagePreloads.size)
            pc.delete(nb), e.highImagePreloads.add(Da);
        } else
          d.imageResources.hasOwnProperty(nb) ||
            ((d.imageResources[nb] = pb),
            (Da = []),
            R(Da, {
              rel: "preload",
              as: "image",
            ...
            "high" === c.fetchPriority || 10 > e.highImagePreloads.size
              ? e.highImagePreloads.add(Da)
              : (e.bulkPreloads.add(Da), pc.set(nb, Da)));
      }
      return jc(a, c, "img");
    case "base":
    case "area":
    ...
    case "head":
      if (2 > f.insertionMode && null === e.headChunks) {
        e.headChunks = [];
        var Ad = vc(e.headChunks, c, "head");
      } else Ad = vc(a, c, "head");
      return Ad;
    case "html":
      if (0 === f.insertionMode && null === e.htmlChunks) {
        e.htmlChunks = [zc];
        var Bd = vc(e.htmlChunks, c, "html");
      } else Bd = vc(a, c, "html");
      return Bd;
    default:
      if (-1 !== b.indexOf("-")) {
  ...
  try {
    ...
    if (null !== d)
      if (0 === a.pendingRootTasks) {
        ...
        Y.length = 0;
        n && null === q && (u(b, sc), u(b, "head"), u(b, tc));
        Vg(a, b, d);
    ...
    for (c = 0; c < J.length; c++) {
      ...
      a: {
        ...
        ra.splice(0, F);
        Na = ye(U, qa.resources, D.renderState);
      }
      if (!Na) {
        a.destination = null;
        c++;
    ...
    0 === a.completedBoundaries.length
      ? ((a.flushScheduled = !1),
        (a = a.resumableState),
        a.hasBody && (u(b, sc), u(b, "body"), u(b, tc)),
        a.hasHtml && (u(b, sc), u(b, "html"), u(b, tc)),
        wa(b),
        na(b),
        b.end())
      : (wa(b), na(b));
...
function dh(a, b) {
  ...
  var n = void 0 === e ? rb : x('<script nonce="' + A(e) + '">'),
    ...
    r = [],
    p = null;
  void 0 !== f && r.push(n, ("" + f).replace(zb, Ab), sb);
  void 0 !== l &&
    ("string" === typeof l
      ? ((p = { src: l, chunks: [] }),
        uc(p.chunks, { src: l, async: !0, integrity: void 0, nonce: e }))
      : ((p = { src: l.src, chunks: [] }),
        uc(p.chunks, {
          src: l.src,
          async: !0,
  ...
  f = [];
  void 0 !== d &&
    (f.push(Jb), f.push(("" + JSON.stringify(d)).replace(zb, Ab)), f.push(Kb));
  d = {
